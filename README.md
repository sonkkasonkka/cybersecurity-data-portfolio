...
Hi! My name is Sofiia Kuvavina, and I am a 3rd-year Cybersecurity student at Igor Sikorsky Kyiv Polytechnic Institute.
...
This area is useful for analytics tasks, preparing data, understanding patterns and working with reports.
...
- SELECT queries, JOIN and GROUP BY;
- subqueries;
- views;
- stored procedures;
- triggers for business rules;
- basic SQL Server security and access control;
- column encryption basics.

This area helps me understand how data is stored, connected, checked and used for analysis or reporting.
...
This area is useful because it helps me look at digital tools not only from the side of functionality, but also from the side of access control, data protection and possible risks.
...
This area gives me a basic understanding of how networks, access rules and technical diagnostics work.
...
- SSH;
- basic buffer overflow analysis;
- CIA Triad and basic security controls.

This area gives me a foundation for understanding secure work with systems, users, permissions and data.
...
For my current analytics/automation direction, I consider this area as an additional technical background.
